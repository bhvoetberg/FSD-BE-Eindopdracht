package nl.novi.fsdbe.security;
...
//                .and()
                ...
                .antMatchers("/photos/**").hasAnyRole("ADMIN","USER")
                .antMatchers("/clientphoto/**").hasAnyRole("ADMIN","USER")
                .antMatchers("/clientplanning/**").hasAnyRole("ADMIN","USER")
